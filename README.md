![docker image](https://github.com/Sathya-S3/nomad-distro-template-test3-test3/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Sathya-S3/nomad-distro-template-test3-test3.git
    cd nomad-distro-template-test3
    ```

    or

    ```sh
    curl-L -o nomad-distro-template-test3.zip "https://github.com/Sathya-S3/nomad-distro-template-test3-test3/archive/main.zip"
    unzip nomad-distro-template-test3.zip
    cd nomad-distro-template-test3
    ```
...
your `docker-compose.yaml` with `ghcr.io/sathya-s3/nomad-distro-template-test3-test3:main` for the services
...
By default, no plugins are included in this distribution. You can find a list of available NOMAD plugins [here](https://nomad-lab.eu/prod/v1/oasis/gui/search/plugins). For a list of official plugins provided by FAIRmat, please see [here](https://github.com/Sathya-S3/.github/blob/main/profile/README.md). For inspiration, you can also check the list of [plugins that are installed on the production NOMAD deployment hosted by FAIRmat](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-distro/-/raw/main/pyproject.toml?ref_type=heads).
...
```sh
docker pull ghcr.io/sathya-s3/nomad-distro-template-test3-test3/jupyter:main
```
...
```sh
git remote add template https://github.com/FAIRmat-NFDI/nomad-distro-template-test3
git fetch template
...
For detailed instructions on how to resolve the merge conflicts between different version we refer you to the latest template release [notes](https://github.com/Sathya-S3/nomad-distro-template-test3-test3/releases/latest)
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/Sathya-S3/nomad-distro-template-test3-test3/manifests/main": unauthorized`
